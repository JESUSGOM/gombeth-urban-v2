...
@Service
public class AnulacionGastoContableService {

    private static final String ORIGEN_GASTO =
            "GASTO_CONTABILIZADO";
    ...
    public AnulacionGastoContableService(
    ...
    @Transactional
    public ContabilidadAsiento anularContabilizacion(
